...
where \(V\) is a vector field. \(\psi:U\) is called a \dhighlight{local trivialisation}. We call 
...
\begin{remark}\marginnote{If the instructor had different tatse, the above construction might as well have been the definition}
    \begin{itemize}
...
\begin{proof}[Proof of theorem \ref{thm:8.4}]
    These definitions are all natural, so how could they fail? % TODO: as a quote
...
What is the name of a section of a tangent bundle? Vector field % TODO: Check
