...
\begin{proof}
    ...
    \begin{figure}[H]\label{fig:5.04}
        \centering
        \includegraphics[width=.7\textwidth]{sketch_5_04.png}
        \caption{Sketch 5.04}
    \end{figure}
...
\begin{lemma}\label{lem:5.4}
    ...
    \begin{figure}[H]\label{fig:5.05}
        \centering
        \includegraphics[width=.7\textwidth]{sketch_5_05.png}
        \caption{Sketch 5.05}
    \end{figure}
\end{lemma}
...
\begin{proof} % TODO: Fix notation
    ...
    \begin{figure}[H]\label{fig:5.06}\marginnote{More by the proof of the theorem ...}
        \centering
        \includegraphics[width=.7\textwidth]{sketch_5_06.png}
        \caption{Sketch 5.06}
    \end{figure}
...
\begin{figure}[H]\label{fig:5.07}
    \centering
    \begin{tikzcd}
        F^{-1}(U)\arrow[r,"F^\vee"]\arrow[d,sloped,"\supset"] & S\arrow[d,sloped,"\supset"]\\
        W\arrow[r] & U \\ 
        (x_1,\dots,x_m)\arrow[r]& (F^{\vee 1}(x_1,\dots,x_m),\dots,F^{\vee k}(x_1,\dots,x_m))
    \end{tikzcd}
    \caption{Sketch 5.07}
\end{figure}
...
\begin{proof}[Proof of theorem \ref{thm:5.6:whithney}]
    ...
    \begin{figure}[H]\label{fig:5.08}
        \centering
        \includegraphics[width=.7\textwidth]{sketch_5_08.png}
        \caption{Sketch 5.08}
    \end{figure}
