...
\begin{proof}
    ...
    \begin{figure}[H]\label{fig:6.17}
        ...
        \begin{tikzcd}
            ...
            X\substack{\times\\Z}Y\arrow[r,hook] & X\times Y
        \end{tikzcd}  
        \caption{Sketch 6.17}
    \end{figure} 
    ...
    The above is equivalent to \marginnote{we solve this, since we want to show \(f\pitchfork g\iff \forall z\in X\substack{\times\\Z}Y:\text{im} df+\text{im}dg=T_zZ\)}
    \begin{align*}
...
\begin{proof}%TODO: FIX + ggf. sketch 6.22
...
\begin{theorem}[Sarel]\label{thm:6.9:sarel}\marginnote{Very important theorem}
...
\begin{proof}
    ...
    \begin{center}
        \begin{tikzcd}
            W=(X\times I)\substack{\times\\Z}Y\arrow[dr,"\pi"] \arrow[rr,hook,"smooth embedding"] && \arrow[dl](X\times I)\times Y\\
            & I &
        \end{tikzcd}      
    \end{center}
